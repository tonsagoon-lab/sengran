...
// Stroke 2, currentColor, matches the production app's lucide-react usage.
...
const ICON_PATHS = {
  ...
  msgCircle:   '<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/>',
  send:        '<path d="M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z"/><path d="m21.854 2.147-10.94 10.939"/>',
  clock:       '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',
  eye:         '<path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"/><circle cx="12" cy="12" r="3"/>',
  camera:      '<path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/><circle cx="12" cy="13" r="3"/>',
  image:       '<rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/>',
  share:       '<path d="M12 2v13"/><path d="m16 6-4-4-4 4"/><path d="M20 17v3a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-3"/>',
  ...
  basket:      '<path d="m5 11 4-7"/><path d="m19 11-4-7"/><path d="M2 11h20"/><path d="m3.5 11 1.6 7.4a2 2 0 0 0 2 1.6h9.8a2 2 0 0 0 2-1.6l1.7-7.4"/><path d="M10 17h4"/>',
  washing:     '<path d="M3 6h3l2 12h12l3-8H7"/><path d="M8 22a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M19 22a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/>',
  car:         '<path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9l-2.7-.6-1.2-2.4A2 2 0 0 0 14.7 7H5a2 2 0 0 0-2 2v7c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/>',
...
function Icon({ name, size = 20, fill = "none", stroke = "currentColor", strokeWidth = 2, style = {} }) {
...
// LINE brand mark (filled — not in Lucide)
function LineIcon({ size = 16, color = "currentColor" }) {
  return (
    <svg width={size} height={size} fill={color} viewBox="0 0 24 24" style={{ display: "inline-block", flexShrink: 0 }}>
