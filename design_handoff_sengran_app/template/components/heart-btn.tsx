// components/heart-btn.tsx — favorite toggle with optimistic update.
// Floats on top of listing photos. Uses the useFavorites hook to
// persist to Supabase.
  ...
  return (
    <button
      ...
      className={cn(
        ...
        floating && "absolute right-2 top-2 bg-white/92 shadow-sm backdrop-blur-sm",
